...
"""Regenerate the xFNO golden ``.pth`` fixtures.

Run from the repository root::

    python test/experimental/models/xdeeponet/data/_generate_xfno_goldens.py
...
``test_xfno.py`` — adding a new scenario there automatically extends this
generator.
...
# xdeeponet test dir: so ``import test_xfno`` resolves.
sys.path.insert(0, str(_REPO_ROOT))
sys.path.insert(0, str(_REPO_ROOT / "test" / "experimental" / "models" / "xdeeponet"))

from test_xfno import (  # noqa: E402
    _FIXTURE_REGISTRY,
    _init_lazy,
)
